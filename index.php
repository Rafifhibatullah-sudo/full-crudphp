                                            ...
                                            <?php foreach ($data_barang as $barang) : ?>
                                                <tr>
                                                    ...
                                                    <td width="20%" class="text-center">
                                                        ...
                                                        <a href="hapus-barang.php?id_barang=<?= $barang['id_barang']; ?>" class="btn btn-danger" onclick="return confirm('Yakin data brang akan di hapus???');"> <i class="fas fa-trash"></i> Hapus</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
                                        </tbody>
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">batalkan</button>
