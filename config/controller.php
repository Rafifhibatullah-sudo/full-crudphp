...
function update_mahasiswa($post)
{
    ...
    //check upload foto abru atau tidak
    ...
    //query ubah data
    $query = "UPDATE mahasiswa SET nama = '$nama', prodi = '$prodi', jk = '$jk', telepon = '$telepon',  alamat = '$alamat', 
...
function upload_file()
{
    ...
    if (!in_array($extensifile, $extensifileValid)) {
        //pesan gagal
        echo "<script>
        alert('format file tidak valid banget nich');
    ...
    if ($ukuranFile > 2048000) {
        echo "<script>
        alert('ukuran file max 2 mb sayang');
        document.location.href = 'tambah-mahasiswa.php'
        </script>";
        die();
    }
