...
// jika tombol di tekan jalankan ke script berikut
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="exampleModalLabel"> <i class="fas fa-plus-circle"></i> tambah akun</h5>
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="level" id="level" class="form-control" required>
                            ...
                            <option value="2">operatorBarang </option>
                            <option value="3">operatorMahasiswa </option>
                        </select>
                    </div>
            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="ubah" class="btn btn-success"> <i class="fas fa-edit"></i>ubah</button>
                </div>
                </form>
            </div>
        </div>
    ...
    <div class="modal fade" id="modalHapus<?= $akun['id_akun']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Yakin mau hapus akun ini? : <?= $akun['nama']; ?> .?</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">kembali</button>
